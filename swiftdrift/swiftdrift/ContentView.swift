...
struct ContentView: View {
    ...
    func settingValue() {
        ...
        modelContext.insert(Mission(name: "공식당", tag: 1, tittle: "솔로문에 있는 계단 갯수를 세어보자", info: "솔로문은 원룸 사유지의 벽이었으나 유동인구가 늘어나며 길이 생겨났다. 인근 충현교회에서 지혜의 상징 솔로몬에서 유래된 'SOLO 문'이라는 문패를 만들어 주었다. 하지만 '솔로들의 문'으로 바뀌어 버렸다. 간격이 좁은 탓에 한 명 한 명씩 지나가야 해서 솔로 문이라는 뜻도 있다.",latitude: 35.8867046, longitude: 128.6057820, pass: false))
